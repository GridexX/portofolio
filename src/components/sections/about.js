...
const About = () => {
  ...
  // const skills = ['TypeScript', 'GO', 'Kubernetes', 'Terraform', 'OpenStack', 'Rust'];
    ...
    <StyledAboutSection id="about" ref={revealContainer}>
      ...
      <div className="inner">
        <StyledText>
          <div>
            <p>
              Hello! My name is Arsène and I enjoy creating things related to Cloud. My interest in
              development started back in 2016 when I got my first Arduino card for Christmas !
            </p>
